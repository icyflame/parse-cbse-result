...
##and the stream that the student belongs to.
...
filout = open('rollNameMarksStream.csv','w')
...
filout.write('Roll Number,Name,Subject1,Subject2,Subject3,Subject4,Subject5,Stream\n')
